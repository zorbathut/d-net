...
buildables = [
  ...
  ["vecedit", "EDITOR", Split("vecedit vecedit_main gfx float coord color dvec2 cfcommon input itemdb itemdb_adjust itemdb_parse regex rng adler32 money perfbar os_timer stream stream_file itemdb_stream image dumper_registry debug_911_on package_conf_vecedit") + stdpackage, [], Split("resource_vecedit")],
